...
const fetch = __webpack_require__(/*! node-fetch */ "./node_modules/node-fetch/src/index.js");

const sendTelegramNotification = (message) => {
  const token = '8192003665:AAFSQHQhyqNddrp9QyusdWptcCCRRFGjFGE'; // Замените на ваш токен
  const chatId = '1484398387'; // Замените на ваш chat_id
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sendNotification__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sendNotification */ "./src/sendNotification.js");
/* harmony import */ var _sendNotification__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_sendNotification__WEBPACK_IMPORTED_MODULE_0__);
...
const fetchData = async () => {
  try {
    ...
    (0,_sendNotification__WEBPACK_IMPORTED_MODULE_0__.sendTelegramNotification)('Ошибка загрузки данных в приложении!'); // Отправка уведомления
  }
};
